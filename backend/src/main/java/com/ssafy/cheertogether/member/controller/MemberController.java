...
import static com.ssafy.cheertogether.member.MemberConstant.CREATABLE_EMAIL_SUCCESS_RESPONSE_MESSAGE;
import static com.ssafy.cheertogether.member.MemberConstant.FIND_PASSWORD_SUCCESS_RESPONSE_MESSAGE;
import static com.ssafy.cheertogether.member.MemberConstant.JOIN_SUCCESS_RESPONSE_MESSAGE;
import static com.ssafy.cheertogether.member.MemberConstant.MODIFY_PASSWORD_SUCCESS_RESPONSE_MESSAGE;
import static com.ssafy.cheertogether.member.MemberConstant.MODIFY_SUCCESS_RESPONSE_MESSAGE;
import static com.ssafy.cheertogether.member.MemberConstant.PLUS_POINT_SUCCESS_RESPONSE_MESSAGE;
import static com.ssafy.cheertogether.member.MemberConstant.SUBTRACT_POINT_SUCCESS_RESPONSE_MESSAGE;
import static com.ssafy.cheertogether.member.MemberConstant.WITHDRAW_SUCCESS_RESPONSE_MESSAGE;
...
public class MemberController {
    ...
    public ResponseEntity<String> reissueToken(
        ...
        Token newToken = memberService.reissueToken(refreshToken);
