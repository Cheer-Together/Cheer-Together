...
public final class MemberConstant {
	...
	public static final String MISMATCH_PASSWORD_ERROR_MESSAGE = "비밀번호가 일치하지 않습니다.";
	public static final String NOT_FOUND_MEMBER_ERROR_MESSAGE = "존재하지 않는 회원입니다.";
    public static final String INVALID_REFRESH_TOKEN_ERROR_MESSAGE = "토큰이 만료되었습니다. 다시 로그인해주세요.";

	public static final String CREATABLE_EMAIL_SUCCESS_RESPONSE_MESSAGE = "사용 가능한 이메일입니다.";
