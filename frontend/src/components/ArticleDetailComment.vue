  ...
  <div v-if="loaded" style="display: flex; height: 40px; margin-bottom: 5px">
    ...
    <div style="font-size: 13px; margin-left: 2px">
      <div style="color: #8d8d8d; display: flex">
        ...
        <div
          v-if="loginUserId == props.reply.memberId || userRole == 'ADMIN'"
          @click="deleteComment()"
          class="word-link"
...
axios({
  url:
    "https://i7b204.p.ssafy.io/cheertogether/members/" + props.reply.memberId,
  method: "GET",
})
  .then((res) => {
...
function deleteComment() {
  axios({
    url:
      "https://i7b204.p.ssafy.io/cheertogether/articles/reply/" +
      props.reply.id,
    method: "DELETE",
  })
    .then((res) => {
